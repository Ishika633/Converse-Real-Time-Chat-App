    ...
    <>
      ...
      >
        <div style={{ marginBottom: "2%", display: "flex", alignItems: "center" }}>
          ...
          <div style={{ color: "black", fontWeight: "bold", display: `${checkroomId}` }}>
            Give a Valid Title
          </div>
        </div>
        ...
        <div style={{ marginTop: "1%", marginBottom: "2%", display: "flex", alignItems: "center" }}>
          <div style={{ position: "relative", marginRight: "8px" }}>
            <input
              ...
              style={{
                padding: "8px", // Increased padding for better input box appearance
                border: "2px solid #ccc", // Added border for better visibility
                borderRadius: "20px", // Rounded corners for a softer look
                width: "400px",
                height: "80px"
              }}
          ...
          <div style={{ color: "black", fontWeight: "bold", display: `${checkroomValid}` }}>
            Not a Valid Room Id
          </div>
        </div>
      </div>
        ...
        {roomList.map((room) => (
          <div
            ...
            style={{
              margin: "10px",
              width: "170px",
              border: "3px solid white", // Adjusted border color to match #483D8B shade
              borderRadius: "8px",
              padding: "15px",
              textAlign: "center",
              backgroundColor: "inherit",// Adjusted background color to match #483D8B shade
              color: "white",
              marginBottom: "200px",
              fontSize: "20px",
              fontWeight: "bolder"
          ...
          >
            <Link
              to={`/room/${room.ider}`}
              style={{ color: "white", textDecoration: "none" }} // Adjusted link color to contrast with #483D8B
            >
              {room.title}
            </Link>
          </div>
